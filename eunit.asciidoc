...
illuminating. I have found that tests for the init function of supervisors is
often hard to test in a way that can prove useful for the developer. These
things should of course be subject to some form of varification, but it does not
